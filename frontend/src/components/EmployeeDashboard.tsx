          ...
          <DialogContent dividers>
            <Grid container spacing={2}>
              {selectedEmployees.map((employee: Employee) => (
                <Grid item xs={12} sm={2} key={employee.Id_number} sx={{ flexBasis: '20%', maxWidth: '20%' }}>
                  <Card sx={{ height: 'auto', minHeight: '140px' }}>
                    <CardContent sx={{ p: 1.5 }}>
                      {/* Row 1: Name - Department */}
                      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 1 }}>
                        <Typography variant="h6" sx={{ fontSize: '14px', fontWeight: 600, flex: 1, mr: 0.5 }}>
                          {employee.full_name}
                        </Typography>
                        <Typography variant="body2" sx={{ fontSize: '12px', color: 'primary.main', fontWeight: 500 }}>
                          {employee.department}
                        </Typography>
                      </Box>
                      ...
                      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        ...
                        <Typography variant="body2" sx={{ fontSize: '12px', color: 'success.main', fontWeight: 500 }}>
                    ...
                    <Box sx={{ margin: 1 }}>
                      ...
                      <Box sx={{ display: 'grid', gridTemplateColumns: 'repeat(6, 1fr)', gap: 2, fontSize: '0.875rem' }}>
                        ...
                        <Box>
                          ...
                          <Box sx={{ mb: 0.75 }}>
                            <Typography variant="caption" color="text.secondary" display="block" sx={{ fontSize: '0.75rem', fontWeight: 'bold' }}>Tax Code:</Typography>
                            <Typography variant="body2" sx={{ fontSize: '0.875rem', wordWrap: 'break-word', whiteSpace: 'normal' }}>{employee.tax_code || '-'}</Typography>
                          </Box>
                          <Box sx={{ mb: 0.75 }}>
